...
mysql -u clarususer -p **şifre ile bağlan

# Show databases for clarususer.
SHOW DATABASES; **clarususer ın görebildiği dbler

# Select the database clarusdb.
USE clarusdb;

# Create a table named offices.**yeni bir offices tablosu oluşturduk
...
# Insert some data into the table named offices.**tabloyu doldurduk.
